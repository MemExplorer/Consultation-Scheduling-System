...
CREATE TABLE tbl_accounts(account_id INT NOT NULL PRIMARY KEY auto_increment, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL,
 ...
 INSERT INTO tbl_accounts VALUES(1 ,"John", "Doe", "johndoe@gmail.com", "test", "student");