...
class images:
    ...
    class nav_ico:
        ...
        list_task_dark = _image_nav_path +  "list_task_dark.png"
        list_task_light = _image_nav_path +  "list_task_light.png"
        history_dark = _image_nav_path +  "history_dark.png"
        history_light = _image_nav_path +  "history_light.png"
        filter_dark = _image_nav_path +  "filter_dark.png"
        filter_light = _image_nav_path +  "filter_light.png"
        sort_dark = _image_nav_path +  "sort_dark.png"
        sort_light = _image_nav_path +  "sort_light.png"
        user_profile_dark = _image_nav_path +  "user_profile_dark.png"
        user_profile_light = _image_nav_path +  "user_profile_light.png"
