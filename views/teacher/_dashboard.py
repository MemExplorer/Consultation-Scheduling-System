...
class DashboardFrame(ctk.CTkFrame):
    ...
    def __init__(self, master, *args, **kwargs):
        ...
        self.TitleLabel = ctk.CTkLabel(self.TitleWrapper, text=f"Welcome back, {self.user_data['username']}!", text_color="black", font=ctk.CTkFont(family="Poppins", size=24, weight='bold'))
