...
class StudentApp(customtkinter.CTk):
    ...
    def __init__(self, user_data: list):
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "CvSU Consult Logo.png")), size=(30, 30))
        ...
        # create home frame
        self.home_frame = customtkinter.CTkFrame(self, corner_radius=0, fg_color=("white", "black"))
