...
class CalendarFrame(ctk.CTkFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.FacultyPicker = ctk.CTkOptionMenu(self.CaledanrUtilitiesWrapper, fg_color=self.THEME_DARKGREEN, dropdown_fg_color=self.THEME_DARKGREEN, button_color=self.THEME_DARKGREEN, button_hover_color=self.THEME_DARKGREEN, text_color=self.DEFAULT)
        ...
        self.calendar = Calendar(self.MainWrapper, selectmode="day", year=datetime.datetime.now().year, month=datetime.datetime.now().month, day=datetime.datetime.now().day)
