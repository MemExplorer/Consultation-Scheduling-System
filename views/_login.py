...
class LogInFrame(ctk.CTkFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #Space
        self.err_label = ctk.CTkLabel(self, text=" ", text_color="red", font=('Arial', 12))
        self.err_label.grid(row=4, column=0, padx=0, pady=3)
        ...
        self.ForgotPass.grid(row=9, column=0, padx=55, pady=0, sticky="e")
