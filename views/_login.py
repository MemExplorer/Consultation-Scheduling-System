...
class LogInFrame(ctk.CTkFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.Email_lbl.grid(row=6, column=0, padx=55, pady=0, sticky="w")
        self.Email = ctk.CTkEntry(self, placeholder_text="Enter your Email", width=285)
        self.Email.grid(row=7, column=0, padx=10, pady=0)


        #Password Label and Entry
        self.Password_lbl = ctk.CTkLabel(self, text="Password:")
        self.Password_lbl.grid(row=8, column=0, padx=55, pady=0, sticky="w")
        self.Password = ctk.CTkEntry(self, placeholder_text="Enter your password", width= 285, show="*")
        self.Password.grid(row=9, column=0, padx=10, pady=0)
        ...
        self.ForgotPass.grid(row=10, column=0, padx=60, pady=0, sticky="e")
        ...
        self.RememberMe.grid(row=11, column=0, padx=55, pady=0, sticky="w")
        
        #space 
        self.space3 = ctk.CTkLabel(self, text=" ")
        self.space3.grid(row=12, column=0, padx=0, pady=7)
        ...
        self.LogIn_btn.grid(row=13, column=0, padx=5, pady=5)
        
        #space 
        self.space3 = ctk.CTkLabel(self, text=" ")
        self.space3.grid(row=14, column=0, padx=0, pady=4)
        ...
        self.SignUp.grid(row=15, column=0, padx=10, pady=15)

        #space 
        self.space3 = ctk.CTkLabel(self, text=" ")
        self.space3.grid(row=16, column=0, padx=0, pady=1)
